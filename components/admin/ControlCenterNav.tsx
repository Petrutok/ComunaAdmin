...
export function ControlCenterNav() {
  ...
  const allNavItems = [
    ...
    { href: '/admin/notificari', label: 'Notificări', icon: Bell, gradient: 'from-amber-600/20 to-amber-800/20', border: 'border-amber-500/30 hover:border-amber-400/50', iconBg: 'bg-amber-500/20', iconColor: 'text-amber-400', roles: ['admin'] },
